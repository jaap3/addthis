  ...
  module AddThisHelper
    ...
    module ClassMethods
      ...
      def addthis_feed_button(url, *args)
        options = extract_addthis_options(args)
      ...
      def addthis_tag(str, options = {})
        ...
        s << %Q{<script type="text/javascript">var addthis_pub="#{CONFIG[:publisher]}";</script>}
        s << str
      ...
      def extract_addthis_url_and_options(args, options = {:title => "[TITLE]"})
